    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', django.contrib.postgres.fields.citext.CICharField(choices=[('agent', 'agent'), ('tenant', 'tenant'), ('transporter', 'transporter')], max_length=255)),
                ('account_type', django.contrib.postgres.fields.citext.CICharField(max_length=100)),
